...
import os
import time
from PyQt5.QtWidgets import (QPushButton,QGridLayout, QDialog, QTreeWidget, QTreeWidgetItem, QVBoxLayout,
                             QHBoxLayout, QProgressBar, QFrame, QLabel, QApplication, QMainWindow)
