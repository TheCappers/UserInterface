...
class Visualization:
    def __init__(self):
        ...
        self.artifacts_pie_data = [(screenshot_data, self.pie_tab_screenshot_checkbox),
                                   (video_data, self.pie_tab_video_checkbox),
                                   (network_data, self.pie_tab_network_checkbox),
                                   (process_data, self.pie_tab_process_checkbox),
                                   (keystroke_data, self.pie_tab_keystroke_checkbox),
                                   (mouse_action_data, self.pie_tab_mouse_action_checkbox),
                                   (window_history_data, self.pie_tab_window_history_checkbox),
                                   (system_call_data, self.pie_tab_system_call_checkbox)]
        ...
        self.artifacts_bar_data = [(bar_graph_artifact_data[0], self.bar_tab_screenshot_checkbox),
                                   (bar_graph_artifact_data[1], self.bar_tab_video_checkbox),
                                   (bar_graph_artifact_data[2], self.bar_tab_network_checkbox),
                                   (bar_graph_artifact_data[3], self.bar_tab_process_checkbox),
                                   (bar_graph_artifact_data[4], self.bar_tab_keystroke_checkbox),
                                   (bar_graph_artifact_data[5], self.bar_tab_mouse_action_checkbox),
                                   (bar_graph_artifact_data[6], self.bar_tab_window_history_checkbox),
                                   (bar_graph_artifact_data[7], self.bar_tab_system_call_checkbox)]
        ...
        self.label_32.setText(_translate("MainWindow", "Data Range"))
        ...
        self.comboBox.setItemText(5, _translate("MainWindow", "Month"))
